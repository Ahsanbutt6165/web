        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <motion.div className="space-y-4" variants={itemVariants}>
            ...
            <div className="flex space-x-3 pt-2">
              <motion.a
                href="https://www.facebook.com/psychhealclinic"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-slate-700 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors duration-300"
              ...
              <motion.a
                href="https://www.instagram.com/psychhealclinic"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-slate-700 hover:bg-pink-600 rounded-full flex items-center justify-center transition-colors duration-300"
                whileHover={{ scale: 1.15 }}
                whileTap={{ scale: 0.95 }}
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 bg-slate-700 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors duration-300"
                whileHover={{ scale: 1.15 }}
                whileTap={{ scale: 0.95 }}
                aria-label="WhatsApp"
              >
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              {[
                ...
                >
                  <Link to={link.path} className="hover:text-teal-400 transition-colors duration-300 inline-block">
                    {link.label}
                  </Link>
                </motion.li>
              ))}
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <motion.li whileHover={{ x: 5 }}>
                <a href="https://wa.me/923303866245" target="_blank" rel="noopener noreferrer" className="hover:text-teal-400 transition-colors duration-300">
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li className="text-red-400 font-medium">Closed</li>
            </ul>
          </motion.div>
        </div>
